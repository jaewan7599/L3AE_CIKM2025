...
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm nv-embed-v2 --model simgcl_plus --reg_weight 1e-8 --cl_weight 0.02 --cl_tau 0.15 --kd_weight 0.02 --kd_tau 0.2
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm nv-embed-v2 --model simgcl_gene --reg_weight 1e-8 --cl_weight 0.02 --cl_tau 0.15 --mask_ratio 0.1 --recon_weight 0.05 --recon_tau 0.1
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm nv-embed-v2 --model alpharec --reg_weight 1e-8 --cl_tau 0.15 --no_pred_norm

### linear
python encoder/train_linear.py --dataset $dataset --device cpu --llm nv-embed-v2 --model text_similarity
python encoder/train_linear.py --dataset $dataset --device cpu --llm nv-embed-v2 --model ease_text --reg_F 5
