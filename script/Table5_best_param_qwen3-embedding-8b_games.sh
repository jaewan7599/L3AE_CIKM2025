...
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model simgcl_plus --llm qwen3-embedding-8b --reg_weight 1e-6 --cl_weight 0.35 --cl_tau 0.35 --kd_weight 0.01 --kd_tau 0.2
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model simgcl_gene --llm qwen3-embedding-8b --reg_weight 1e-6 --cl_weight 0.35 --cl_tau 0.35 --mask_ratio 0.1 --recon_weight 0.1 --recon_tau 0.1
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model alpharec --reg_weight 0 --cl_tau 0.3 --no_pred_norm
...
python encoder/train_linear.py --dataset=$dataset --device cpu --llm qwen3-embedding-8b --model l3ae --reg_X 0 --reg_F 5 --reg_E 100