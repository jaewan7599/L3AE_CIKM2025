...
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm llama-3.2-3b --model simgcl_plus --reg_weight 1e-6 --cl_weight 0.1 --cl_tau 0.2 --kd_weight 0.05 --kd_tau 0.25
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm llama-3.2-3b --model simgcl_gene --reg_weight 1e-8 --cl_weight 0.02 --cl_tau 0.15 --mask_ratio 0.1 --recon_weight 0.05 --recon_tau 0.1
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --llm llama-3.2-3b --model alpharec --reg_weight 1e-6 --cl_tau 0.15
...
python encoder/train_linear.py --dataset=$dataset --device cpu --llm llama-3.2-3b --model l3ae --reg_X 20 --reg_F 0.05 --reg_E 80
