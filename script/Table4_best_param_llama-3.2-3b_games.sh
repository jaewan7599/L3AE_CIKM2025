...
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model simgcl_plus --llm llama-3.2-3b --reg_weight 1e-6 --cl_weight 0.02 --cl_tau 0.2 --kd_weight 0.01 --kd_tau 0.2
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model simgcl_gene --llm llama-3.2-3b --reg_weight 1e-6 --cl_weight 0.02 --cl_tau 0.2 --mask_ratio 0.1 --recon_weight 0.1 --recon_tau 0.1
python encoder/train_encoder.py --dataset $dataset --cuda $gpu --model alpharec --reg_weight 1e-8 --cl_tau 0.25 --no_pred_norm

### linear
python encoder/train_linear.py --dataset $dataset --device cpu --llm llama-3.2-3b --model text_similarity
python encoder/train_linear.py --dataset $dataset --device cpu --llm llama-3.2-3b --model ease_text --reg_F 0.1
...
python encoder/train_linear.py --dataset=$dataset --device cpu --llm llama-3.2-3b --model l3ae --reg_X 20 --reg_F 0.1 --reg_E 80